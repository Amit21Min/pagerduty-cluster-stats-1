#!/bin/bash
echo "cn:;rhatJobTitle:;rhatOfficeLocation:;co:;employeeType:;rhatGeo:;hatCostCenterDesc:;rhatCostCenter:;rhatLocation:;mail;l:;creation_timestamp">full_list.csv
for i in `ls RH_*`
do
...
echo "$CN;$RHATJOBTITLE;$RHATOFFICELOCATION;$CO;$EMPLOYEETYPE;$RHATGEO;$RHATCOSTCENTERDESC;$RHATCOSTCENTER;$RHATLOCATION;$MAIL;$L;$DOH" >> full_list.csv
done
rm RH_*
